                                                                                     ...
                                                                                     fluidRow(
                                                                                       column(3, wellPanel(p('Set models'),
                                                                                                           ...
                                                                                                           conditionalPanel(condition = 'input.BDvarSpeModML == 1',
                                                                                                                            ...
                                                                                                                            selectInput(inputId = 'optiMethModML',label = 'Metodo de optimización',choices = c( 'optim', 'subplex', 'nminb', 'nlm')),
                                                                                                           ...
                                                                                                           conditionalPanel(condition = 'input.BDvarExtModML == 1',
                                                                                                                            ...
                                                                                                                            selectInput(inputId = 'optiMethExtModML',label = 'Metodo de optimización',choices = c( 'optim', 'subplex', 'nminb', 'nlm')),
                                                                                                           ...
                                                                                                           conditionalPanel(condition = 'input.BDvarSpeExtModML == 1',
                                                                                                                            ...
                                                                                                                            selectInput(inputId = 'optiMethSpeExtModML',label = 'Metodo de optimización',choices = c( 'optim', 'subplex', 'nminb', 'nlm')),
